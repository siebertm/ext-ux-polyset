...
Ext.ux.PolySet = Ext.extend(Ext.form.Field, {
  ...
  addPanel: function(value) {
    ...
    var pnl = this.panel.insert(this.panel.items.getCount(), this._getRow(this._getContentPanel(value)));
  ...
  onRender: function(ct, position) {
    if (!this.el) {
      ...
      var buttons = [];
      Ext.each(this.addButtons || [{}], function(button) {
        buttons.push(Ext.apply(button, {
          xtype: "button",
      ...
      this.panel.ownerCt = this.ownerCt;
  ...
  _onBtnAdd: function(btn) {
    this.addPanel(btn.addValue);
  },
